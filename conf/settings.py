...
LANGUAGE_CODE = env.str("LANGUAGE_CODE", default="sk")

TIME_ZONE = env.str("TIME_ZONE", default="Europe/Bratislava")
...
STATIC_ROOT = env.path("STATIC_ROOT", default=BASE_DIR / "static_files")
